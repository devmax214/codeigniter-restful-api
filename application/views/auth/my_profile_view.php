...
?>
<?php echo form_open('', array('class' => 'form-horizontal'), $hidden)?>

<div class="control-group form_item <?php echo (form_error('first_name') != '' ? 'error' : '')?>">
            <?php echo form_label('First Name: *', 'first_name_field', array('class' => 'control-label'))?>
            <div class="controls">
<?php
// form value
...
?>
              <?php echo form_input(array('name' => 'first_name', 'id' => 'first_name_field', 'class' => 'span3', 'value' => $value))?>
...
<div class="control-group form_item <?php echo (form_error('last_name') != '' ? 'error' : '')?>">
            <?php echo form_label('Last Name: *', 'last_name_field', array('class' => 'control-label'))?>
            <div class="controls">
<?php
// form value
...
?>
              <?php echo form_input(array('name' => 'last_name', 'id' => 'last_name_field', 'class' => 'span3', 'value' => $value))?>
...
<div class="control-group form_item <?php echo (form_error('old_password') != '' ? 'error' : '')?>">
            <?php echo form_label('Old Password: *', 'old_password_field', array('class' => 'control-label'))?>
            <div class="controls">
<?php
// form value
...
?>
              <?php echo form_password(array('name' => 'old_password', 'id' => 'old_password_field', 'class' => 'span3', 'value' => $value))?>
...
<div class="control-group form_item <?php echo (form_error('password') != '' ? 'error' : '')?>">
            <?php echo form_label('New Password: *', 'password_field', array('class' => 'control-label'))?>
            <div class="controls">
<?php
// form value
...
<div class="control-group form_item <?php echo (form_error('confirm_password') != '' ? 'error' : '')?>">
            <?php echo form_label('Confirm New Password: *', 'confirm_password_field', array('class' => 'control-label'))?>
            <div class="controls">
<?php
// form value
...
?>
              <?php echo form_password(array('name' => 'confirm_password', 'id' => 'confirm_password_field', 'class' => 'span3', 'value' => $value))?>
...
<a href="<?php echo base_url()?>contest/cancel?redirect=<?php echo urlencode('contest/list_items/' . $this->input->get('from'))?>" class="btn btn-large btn-danger"><i class="icon-remove icon-white"></i> Cancel</a>
